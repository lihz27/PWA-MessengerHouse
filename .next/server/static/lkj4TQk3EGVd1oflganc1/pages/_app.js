...
var external_next_redux_wrapper_ = __webpack_require__(12);
...
var redux_offline_ = __webpack_require__(13);

// EXTERNAL MODULE: external "@redux-offline/redux-offline/lib/defaults"
var defaults_ = __webpack_require__(14);
  ...
  switch (type) {
    case actions["a" /* ADD_HOUSE */]:
      return [{
        ...
        username: username,
        imgUrl: imgUrl
      }].concat(houseReducer_toConsumableArray(state));
