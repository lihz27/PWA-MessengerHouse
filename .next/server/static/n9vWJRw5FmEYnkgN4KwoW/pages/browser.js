...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return testNotification; });
...
var testNotification = function testNotification() {
  if ('Notification' in window) {
    if (Notification.permission === 'granted') {
      navigator.serviceWorker.getRegistration().then(function (reg) {
        ...
        reg.showNotification('Hello world!', options).then(function (thing) {
          return console.log('this is the thing', thing).catch(function (err) {
...
/* harmony import */ var _utils_notification__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(30);
...
function (_React$Component) {
  ...
  _createClass(Browser, [{
    ...
    value: function componentDidMount() {
      Object(_utils_notification__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(); // const script_Top = document.createElement("script");
